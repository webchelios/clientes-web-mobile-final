    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-8">
                <MainH1 class="text-3xl text-gray-900">Posts de la comunidad</MainH1>
                <p class="mt-2 text-gray-600">Compartí tus ideas y descubrí lo que otros están publicando</p>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-1">
                    <section class="bg-white p-6 rounded-lg shadow">
                        <Subtitle class="text-xl text-gray-800 mb-4">Crear un nuevo Post</Subtitle>

                        <form @submit.prevent="sendPost" class="space-y-4">
                            <div>
                                <MainLabel class="block text-gray-700 mb-1">Autor</MainLabel>
                                <p class="text-gray-900 font-medium">{{ authUser.displayName ? authUser.displayName :
                                    authUser.email }}</p>
                            </div>

                            <div>
                                <MainLabel for="title" class="block text-gray-700 mb-1">Título <span
                            ...
                            <div>
                                <MainLabel for="post" class="block text-gray-700 mb-1">Contenido <span
                                        class="text-red-600">*</span></MainLabel>
                            ...
                            <div>
                                ...
                                <label
                                    ...
                                    <input type="file" id="img" accept="image/*" @change="handleFileSelection"
                                        :disabled="creatingPost" class="hidden">
                                </label>

                                <div v-if="imgPreview" class="mt-3">
                                    <div class="relative">
                                        <img :src="imgPreview" alt="Vista previa"
                                            class="w-full max-h-60 object-contain rounded border border-gray-200">
                                        <button @click="img = null; imgPreview = null"
                            ...
                            <div class="pt-2">
                                <SendButton type="submit"
                                    class="w-full py-2 px-4 rounded text-white bg-orange-600 hover:bg-orange-700 disabled:opacity-50"
                ...
                <div class="lg:col-span-2">
                    <section class="bg-white p-6 rounded-lg shadow">
                        <Subtitle class="text-xl text-gray-800 mb-4">Posts Recientes</Subtitle>
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:justify-between gap-4">
                                        <div class="flex-1">
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <h2 class="text-lg font-bold text-gray-900 hover:text-orange-600">
                                                        {{ post.title }}</h2>
                                            ...
                                            <div v-if="post.img" class="mt-3">
                                                <img :src="post.img" alt="Imagen del post"
                                                    class="max-h-60 w-auto rounded border border-gray-200">
                                            </div>
                                        </div>
