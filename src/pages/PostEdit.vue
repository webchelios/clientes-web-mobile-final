  ...
  <div class="min-h-screen bg-gray-50 py-8 px-4">
    <div class="max-w-5xl mx-auto">
      <div class="flex justify-between items-center mb-8">
        <MainH1 class="text-2xl text-gray-900">Editar Publicación</MainH1>
        <router-link :to="`/post/${oldPost.id}`"
      ...
      <div class="bg-white shadow rounded-lg">
        ...
        <div class="border-t border-gray-200">
          <form @submit.prevent="sendEditedPost" class="divide-y divide-gray-200">
            ...
            <div class="py-4 grid grid-cols-1 md:grid-cols-3 gap-4 px-4">
              <div>
              ...
              <div class="md:col-span-2">
                <input type="text" id="title" v-model="oldPost.title" :disabled="creatingPost"
                  class="w-full border border-gray-300 rounded disabled:bg-gray-100"
            ...
            <div class="py-4 grid grid-cols-1 md:grid-cols-3 gap-4 px-4">
              ...
              <div class="md:col-span-2">
                <textarea id="content" rows="6" v-model="oldPost.content" :disabled="creatingPost"
                  class="w-full border border-gray-300 rounded disabled:bg-gray-100"
                  :class="{ 'border-red-500': showValidationError && !oldPost.content?.trim() }"></textarea>
              </div>
            </div>

            <div v-if="showValidationError" class="px-4 py-3 bg-red-50">
            ...
            <div class="px-4 py-3 bg-gray-50 text-right">
              <button type="submit" :disabled="creatingPost"
                class="py-2 px-4 rounded text-white bg-yellow-600 hover:bg-yellow-700 disabled:opacity-50">
